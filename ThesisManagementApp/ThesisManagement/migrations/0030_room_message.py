...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('ThesisManagement', '0029_alter_user_date_of_birth'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('room', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='messages', to='ThesisManagement.room')),
